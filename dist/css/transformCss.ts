import { getVarName } from '../private/index.ts';
import cssesc from '../deps/cssesc.ts';
import AhoCorasick from '../deps/ahocorasick.ts';
...
import { markCompositionUsed } from './adapter.ts';
import { forEach, omit, mapKeys } from './utils.ts';
import { validateSelector } from './validateSelector.ts';
import { ConditionalRuleset } from './conditionalRulesets.ts';
import { simplePseudos, simplePseudoLookup } from './simplePseudos.ts';
